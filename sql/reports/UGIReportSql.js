...
export const selectUGIquery = `
    ...
    SELECT 
        ...
        report.UgisanCalculatePercent(0, 12.52, ISNULL(HDPL / CRT.P ,0), 0)  AS 'UGI211_rank', report.UgisanCalculateScore(0, 12.52, ISNULL(HDPL / CRT.P ,0), 0)  AS 'UGI211', 
        ...
        report.UgisanCalculatePercent(0, 16.9, ISNULL(A_KGT / CRT.P ,0), 1)  AS 'UGI311_rank', report.UgisanCalculateScore(0, 16.9, ISNULL(A_KGT / CRT.P ,0), 1)  AS 'UGI311', 
        ...
        report.UgisanCalculatePercent(1.2, 2.87, ISNULL(MALA / CRT.P ,0), 1)  AS 'UGI313_rank', report.UgisanCalculateScore(1.2, 2.87, ISNULL(MALA / CRT.P ,0), 1)  AS 'UGI313', 
        ...
        report.UgisanCalculatePercent(1.24, 8.09, ISNULL(CAA / CRT.P ,0), 1)  AS 'UGI316_rank', report.UgisanCalculateScore(1.24, 8.09, ISNULL(CAA / CRT.P ,0), 1)  AS 'UGI316', 
        ...
        report.UgisanCalculatePercent(4.02, 21.35, ISNULL(ISCT / CRT.P ,0), 1)  AS 'UGI318_rank', report.UgisanCalculateScore(4.02, 21.35, ISNULL(ISCT / CRT.P ,0), 1)  AS 'UGI318', 
        ...
        report.UgisanCalculatePercent(0, 0.97, ISNULL(MTML / CRT.P ,0), 0)  AS 'UGI331_rank', report.UgisanCalculateScore(0, 0.97, ISNULL(MTML / CRT.P ,0), 0)  AS 'UGI331', 
        ...
        report.UgisanCalculatePercent(0, 0.73, ISNULL(DHPP / CRT.P ,0), 0)  AS 'UGI522_rank', report.UgisanCalculateScore(0, 0.73, ISNULL(DHPP / CRT.P ,0), 0)  AS 'UGI522', 
        ...
        report.UgisanCalculatePercent(0.19, 2.96, ISNULL(VNMD / CRT.P ,0), 1)  AS 'UGI613_rank', report.UgisanCalculateScore(0.19, 2.96, ISNULL(VNMD / CRT.P ,0), 1)  AS 'UGI613', 
        ...
        report.UgisanCalculatePercent(0, 2.4, ISNULL(QNL / CRT.P ,0), 0)  AS 'UGI622_rank', report.UgisanCalculateScore(0, 2.4, ISNULL(QNL / CRT.P ,0), 0)  AS 'UGI622', 
        report.UgisanCalculatePercent(1.69, 4.59, ISNULL(PCL / CRT.P ,0), 1)  AS 'UGI623_rank', report.UgisanCalculateScore(1.69, 4.59, ISNULL(PCL / CRT.P ,0), 1)  AS 'UGI623'
