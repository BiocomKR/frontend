...
export const selectUGIquery = `
    ...
    SELECT 
        ...
        report.UgisanCalculatePercent(0, 2.8065, ISNULL(HDPL / CRT.P ,0), 0)  AS 'UGI211_rank', report.UgisanCalculateScore(0, 2.8065, ISNULL(HDPL / CRT.P ,0), 0)  AS 'UGI211', 
        ...
        report.UgisanCalculatePercent(9.3275, 47.8765, ISNULL(CAA / CRT.P ,0), 1)  AS 'UGI316_rank', report.UgisanCalculateScore(9.3275, 47.8765, ISNULL(CAA / CRT.P ,0), 1)  AS 'UGI316', 
        ...
        report.UgisanCalculatePercent(0, 3.328, ISNULL(XTR / CRT.P ,0), 0)  AS 'UGI327_rank', report.UgisanCalculateScore(0, 3.328, ISNULL(XTR / CRT.P ,0), 0)  AS 'UGI327', 
        ...
        report.UgisanCalculatePercent(0, 7.9575, ISNULL(CTRM / CRT.P ,0), 0)  AS 'UGI546_rank', report.UgisanCalculateScore(0, 7.9575, ISNULL(CTRM / CRT.P ,0), 0)  AS 'UGI546', 
        ...
        report.UgisanCalculatePercent(0, 5.1925, ISNULL(KNR / CRT.P ,0), 0)  AS 'UGI621_rank', report.UgisanCalculateScore(0, 5.1925, ISNULL(KNR / CRT.P ,0), 0)  AS 'UGI621', 
        report.UgisanCalculatePercent(0, 5.5215, ISNULL(QNL / CRT.P ,0), 0)  AS 'UGI622_rank', report.UgisanCalculateScore(0, 5.5215, ISNULL(QNL / CRT.P ,0), 0)  AS 'UGI622', 
